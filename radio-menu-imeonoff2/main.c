...
int main(int argc, char *argv[])
{
  ...
  ibus_factory_add_engine(factory, "radiomenuimeonoff2", IBUS_TYPE_SAMPLE_ENGINE);

  if (execute_by_ibus) {
    ibus_bus_request_name(bus, "com.example.IBus.RADIOMENUIMEONOFF2", 0);
  } else {
    IBusComponent *component = ibus_component_new("com.example.IBus.RADIOMENUIMEONOFF2",
                                                  "Radio Menu IME On Off 2",
                                                  "1.0",
                                                  "MIT",
                                                  "Kentaro Hayashi",
                                                  "https://github.com/kenhys/ibus-examples",
                                                  "",
                                                  "ibus-engine-radiomenuimeonoff2");
    IBusEngineDesc *description = ibus_engine_desc_new("radiomenuimeonoff2",
                                                       "RadioMenuIMEOnOff2",
                                                       "Radio Menu IME On Off 2 (Japanese Input Method)",
                                                       "ja",
                                                       "MIT",
                                                       "Kentaro Hayashi",
                                                       "",
