...
ibus_radiomenuflickered_engine_class_init(IBusRadioMenuFlickeredEngineClass *klass)
{
  ...
  ibus_object_class->destroy = (IBusObjectDestroyFunc)ibus_radiomenuflickered_engine_destroy;
...
ibus_radiomenuflickered_engine_init(IBusRadioMenuFlickeredEngine *engine)
{
  ...
  label = ibus_text_new_from_static_string("Radio Menu Flickered Test");
...
ibus_radiomenuflickered_engine_destroy(IBusRadioMenuFlickeredEngine *engine)
{
  ...
  ((IBusObjectClass *)ibus_radiomenuflickered_engine_parent_class)->destroy((IBusObject *)engine);
}
...
{
  GError *error = NULL;
  GOptionContext *context = g_option_context_new("- IBus RadioMenuFlickered engine");
  ...
  ibus_factory_add_engine(factory, "radiomenuflickered", IBUS_TYPE_RADIOMENUFLICKERED_ENGINE);

  if (execute_by_ibus) {
    ibus_bus_request_name(bus, "com.example.IBus.RADIOMENUFLICKERED", 0);
  } else {
    IBusComponent *component = ibus_component_new("com.example.IBus.RADIOMENUFLICKERED",
                                                  "Radio Menu",
                                                  "1.0",
                                                  "MIT",
                                                  "Kentaro Hayashi",
